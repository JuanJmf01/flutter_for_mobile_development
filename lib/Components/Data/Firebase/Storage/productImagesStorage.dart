...
class ProductImagesStorage {
  ...
  static Future<String> updateImage(Asset newImage, String fileName,
  ...
  static Future<bool> deleteImage(String fileName, String imageName,
      int idProducto, int idProductImage) async {
    try {
      final Reference ref = FirebaseStorage.instance
          .ref()
          .child('imagenes/$fileName/$idProducto/$imageName');
